...
const Welcome = () => {
  ...
  return (
    <div className="flex w-full mf:flex-row justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 px-4">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10 ">
          <h1 className="text-4xl sm:text-7xl text-white py-1 font-semibold">
            LUCKY GAMES <br />
            <p className="text-left mt-5 font-light text-2xl text-yellow-400">
              ... luck is locating you while having fun for climate sustainability!
            </p>
          </h1><br />
          <p className="text-left mt-5 text-white font-light text-3xl ">
            First Autonomous World, <br /> MUD-Framework Controlled <br />Ambitious Ethereum Application, <br /> Player - Oriented Game. <br /> Get Rewarded Having Fun.
          </p><br />
          <p className="text-left mt-5 font-light text-2xl text-yellow-400">
            Click below to play! <br /> 
            Be the next lucky player now!
          </p>
          {/**
          ...
          <button
            ...
            className="flex flex-row justify-center items-center  my-20 bg-green-300 p-3 rounded-full cursor-pointer hover:bg-green-800 hover:text-white text-black text-3xl font-semibold py-5 px-20"
          >
