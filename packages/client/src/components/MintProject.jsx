...
const MintProject = () => {
  ...
  const uploadNFTContent = async (inputFile) => {
    ...
    try {
      ...
      setErrorMessage("Could not save Project to NFT.Storage - Aborted minting Project.");
  ...
  const sendTxToBlockchain = async (metadata) => {
    try {
      ...
      console.log("Project successfully created and sent to Blockchain");
  ...
  const previewNFT = (metaData, mintNFTTx) => {
    ...
    setTxURL(`https://goerli-optimism.etherscan.io/testnet/tx/${mintNFTTx.hash}`);
    setTxStatus("Project registration was successfully!");
  ...
  return (
    <div className="bg-green-700">
      <div className="text-4xl text-center text-white font-bold mt-10 bg-green-700 pt-5">
      ...
      <div className="flex justify-center">
        <div className="w-1/2 flex flex-col pb-12 ">
          ...
          ><option value="select">Click to select type of project</option>
            ...
            <option value="agriculture">3. Sustainable agriculture:</option>
            <option value="corporate">4. Corporate responsibility:</option>
            <option value="education">5. Education and awareness:</option>
          </select>
          <textarea
          ...
          />
          <input
            placeholder="Total Project Amount (in USD)"
            className="mt-5 border rounded p-4 text-xl"
          ...
          <div className="MintNFT text-white text-xl">
            <form>
              <h3>Upload a picture of completed project </h3>
